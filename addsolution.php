...
//	echo $sql;echo "<br>";
	...
	$sql="INSERT INTO {$oj->prefix}solution(problem_id,user_id,in_date,language,ip,code_length) VALUES('$problem_id','$userdata->ID',NOW(),'$language','$ip','$len')";
//	echo $sql;echo "<br>";
	$wpdb->query($sql);	
	$insert_id=mysql_insert_id();
	$sql="INSERT INTO `{$oj->prefix}solution_source`(`solution_id`,`source`)VALUES('$insert_id','$solution_source')";
//	echo $sql;echo "<br>";
	$wpdb->query($sql);
